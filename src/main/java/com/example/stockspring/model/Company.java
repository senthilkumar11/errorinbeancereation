...
public class Company {
	...
	public Company(@Size(min = 1, message = "Required") String companyName, BigDecimal turnOver, String ceo,
			String boardOfDirectors, int sectorId, String briefWriteUp, int stockPriceId, List<StockPrice> stockPrice) {
		super();
